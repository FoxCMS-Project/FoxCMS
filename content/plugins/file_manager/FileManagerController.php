...
// browse
    ...
    public function save() {
        ...
        // security (remove all ..)
        $data['name'] = str_replace('..', '', remove_xss($data['name']));
    ...
    public function create_file() {
        ...
        $data = remove_xss($_POST['file'], true);
    ...
    public function create_directory() {
        ...
        $data = remove_xss($_POST['directory'], true);
    ...
    public function upload() {
        ...
        $data = $_POST['upload'];
        $path = str_replace('..', '', remove_xss($data['path']));
        $overwrite = isset($data['overwrite']) ? true : false;

        // Clean filenames
        $filename = preg_replace('/ /', '_', remove_xss($_FILES['upload_file']['name']));
        ...
        if (isset($_FILES)) {
            $file = $this->_upload_file($filename, FILES_DIR . '/' . $path . '/', remove_xss($_FILES['upload_file']['tmp_name']), $overwrite);
    ...
    public function rename() {
        ...
        $data['current_name'] = str_replace('..', '', remove_xss($data['current_name']));
        $data['new_name'] = str_replace('..', '', remove_xss($data['new_name']));
