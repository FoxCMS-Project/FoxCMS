...
/*
 ...
 |  @file       ./system/views/page/index.php
...
<h1><?php _e("Pages"); ?></h1>
<div id="site-map-def">
    <div class="page"><?php _e("Page"); ?> (<a href="#" id="toggle_reorder"><?php _e("reorder"); ?></a>)</div>
    <div class="page-layout"><?php _e("Layout"); ?></div>
    <div class="status"><?php _e("Status"); ?></div>
    <div class="view"><?php _e("View"); ?></div>
...
<ul id="site-map-root">
    <li id="page-0" class="node level-0">
        <div class="page" style="padding-left: 4px;">
            <span class="w1">
                <?php if(!AuthUser::hasPermission("page_edit") || ($root->is_protected && !AuthUser::hasPermission("admin_edit"))){ ?>
                    <img src="<?php get_theme_path("../../images/page.png"); ?>" align="middle" alt="page icon" class="icon" />
                    <span class="title"><?php echo $root->title; ?></span>
                <?php } else { ?>
                    <a href="<?php echo get_url("page/edit/1"); ?>">
                        <img src="<?php get_theme_path("../../images/page.png"); ?>" align="middle" alt="page icon" class="icon" />
                        <span class="title"><?php echo $root->title; ?></span>
                    </a>
                <?php } ?>
        ...
        <div class="status published-status">
            <?php _e("Published"); ?>
        </div>
        <div class="view view-page">
            <a href="<?php echo PUBLIC_URL; ?>" target="_blank">
                <img src="<?php get_theme_path("../../images/magnify.png"); ?>" align="middle" alt="<?php _e("View Page"); ?>" title="<?php _e("View Page"); ?>" />
            </a>
        </div>
        <div class="modify">
            <a href="<?php echo get_url("page/add/1"); ?>">
                <img src="<?php get_theme_path("../../images/plus.png"); ?>" align="middle" alt="<?php _e("Add Child"); ?>" title="<?php _e("Add Child"); ?>" />
            </a>
            <img src="<?php get_theme_path("../../images/icon-remove-disabled.png"); ?>" align="middle" alt="<?php _e("remove icon disabled"); ?>" title="<?php _e("Remove unavailable"); ?>" />
            <img src="<?php get_theme_path("../../images/copy-disabled.png"); ?>" align="middle" alt="<?php _e("Copy Page Disabled"); ?>" title="<?php _e("Copy Page Disabled"); ?>" />
        </div>

        <?php print($content_children); ?>
    </li>
</ul>
    ...
    jQuery.fn.expandableSetup = function expandableSetup() {
        $(this).live('click', function() {
            if ($(this).hasClass("expanded")) {
                ...
                $(this).attr('src', '<?php echo get_theme_path("../../images/expand.png"); ?>');
                ...
                $(this).attr('src', '<?php echo get_theme_path("../../images/collapse.png"); ?>');
                var parent = $(this).parents("li.node:first");
                var parentId = parent.attr('id').split('_')[1];
